...
public class NavigationService
{
    public IEnumerable<BDrawerMenuItemModel> GetMenuHierarchy()
    {
        ...
        return navigationItems
            ...
            {
                SvgIcon? resolvedIcon = SvgIconResolver.Resolve(navigationItem.IconString, navigationItem.SvgIconString);
    ...
    public List<BDrawerMenuItemModel> GetChildren(NavigationItemAttribute parent, List<NavigationItemAttribute> allItems)
    {
        ...
        return allItems
            ...
            .Select(group =>
            {
                ...
                SvgIcon? resolvedIcon = SvgIconResolver.Resolve(firstItem.IconString, firstItem.SvgIconString);
