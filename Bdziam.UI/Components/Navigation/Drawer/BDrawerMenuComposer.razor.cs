...
namespace Bdziam.UI
{
    ...
    {
        [CascadingParameter] 
        public BDrawerMenu DrawerMenu { get; set; }
        ...
        private RenderFragment RenderMenuItem(BDrawerMenuItemModel item) => builder =>
        {
            ...
            if (item.Children.Count > 0)
            {
                builder.AddAttribute(5, "ChildContent", (RenderFragment)(childBuilder =>
                {
                    ...
                    {
                        childBuilder.AddContent(6, RenderMenuItem(child));
                    }
                }));
            }
