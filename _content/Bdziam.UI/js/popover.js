...
export function initializePopover(popoverId, targetId, options, dotNetHelper, matchWidth = false) {
    const popoverElement = document.getElementById(popoverId);
    const targetElement = document.getElementById(targetId);
    if (!popoverElement || !targetElement) return;

    // Position the popover
    positionPopover(popoverElement, targetElement, options, matchWidth);
...
function positionPopover(popoverElement, targetElement, options, matchWidth) {
    ...
    if(matchWidth) popoverElement.style.width = targetRect.width+"px";
}
